...
public class PnStreamExceptionCodes extends PnExceptionsCodes {
    ...
    public static final String ERROR_CODE_STREAM_SCHEDULE_EVENTFAILED = "PN_STREAM_SCHEDULE_EVENTFAILED";
    public static final String ERROR_CODE_STREAM_CONFIGURATION = "PN_STREAM_CONFIGURATIONERROR";
