...
import it.pagopa.pn.stream.dto.transition.TransitionRequest;
...
import static it.pagopa.pn.stream.exceptions.PnStreamExceptionCodes.ERROR_CODE_STREAM_NOTIFICATIONSTATUSFAILED;
import static it.pagopa.pn.stream.service.mapper.SmartMapper.mapTimelineInternal;
...
public class StatusUtils {
    ...
    private NotificationStatusInt getNextState(NotificationStatusInt currentState, List<TimelineElementCategoryInt> relatedCategoryElements, int numberOfRecipient) {
        ...
        throw new PnInternalException("No related category for this timeline element", ERROR_CODE_STREAM_NOTIFICATIONSTATUSFAILED);
    }
