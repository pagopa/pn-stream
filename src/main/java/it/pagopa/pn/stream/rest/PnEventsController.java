...
public class PnEventsController implements EventsApi {
    ...
    @Override
    public Mono<ResponseEntity<Flux<ProgressResponseElementV30>>> consumeEventStreamV30(String xPagopaPnUid, CxTypeAuthFleet xPagopaPnCxType, String xPagopaPnCxId, UUID streamId, List<String> xPagopaPnCxGroups, String xPagopaPnApiVersion, String lastEventId, final ServerWebExchange exchange) {
