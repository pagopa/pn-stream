...
class StreamMetadataResponseTest {
    ...
    void setUp() {
        ...
        response.setEventType(StreamMetadataResponseV29.EventTypeEnum.STATUS);
    ...
    @Test
    void getEventType() {
        Assertions.assertEquals(StreamMetadataResponseV29.EventTypeEnum.STATUS, response.getEventType());
    }
