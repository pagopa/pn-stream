...
class StreamMetadataResponseTest {
    ...
    void title() {
        Instant instant = Instant.parse("2021-09-16T15:23:00.00Z");
        StreamMetadataResponseV30 expected = StreamMetadataResponseV30.builder()
                .title("002")
                .streamId(UUID.fromString("f8c3de3d-1fea-4d7c-a8b0-29f63c4c3454"))
                .activationDate(instant)
                .eventType(StreamMetadataResponseV30.EventTypeEnum.STATUS)
    ...
    void eventType() {
        ...
        StreamMetadataResponseV30 expected = StreamMetadataResponseV30.builder()
                ...
                .groups(Collections.emptyList())
                .build();
        Assertions.assertEquals(expected, response.eventType(StreamMetadataResponseV30.EventTypeEnum.STATUS));
    }

    @Test
    void getEventType() {
        Assertions.assertEquals(StreamMetadataResponseV30.EventTypeEnum.STATUS, response.getEventType());
    }
